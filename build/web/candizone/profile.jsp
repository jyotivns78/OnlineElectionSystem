                ...
                <img src="../images/user.jpg" class="img-responsive" height="300px" width="300px" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-6" style="font-family: times new roman;font-size: 20px;">
                            ...
                            ResultSet rs2=db2.selectQuery("select * from regcandidate where email='"+id+"'");
                            while(rs2.next())
                            {
                       %>  
                       ...
                       Gender : <br><br>
                        ...
                        <div class="col-sm-6" style="font-family: times new roman;font-size: 20px;">
                            ...
                            <a href="candiwelcome.jsp"> <button style="background:#ff5a60;border:none;color:white;font-family: times new roman;">Back To Home</button></a>
                            </div>
                        </div>
                    </div>
