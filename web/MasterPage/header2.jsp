  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right" >
          ...
          <li><a class="hvr-trim" href="userhome.jsp" ><span class="glyphicon glyphicon-home"></span> Home</a></li>
          <li><a class="hvr-trim" href="profile.jsp"><span class="fa fa-user"></span> My Profile</a></li>
         <li><a class="hvr-trim" href="letsvote.jsp"><span class="fa fa-tint"></span> Lets Vote</a></li>
