        ...
        <div class="col-sm-12 ">
            ...
            <div class="col-sm-12 tt"> 
               ...
               <div class="col-sm-6  reg ">
                    <form action="candicode/cregcode.jsp" method="post">
                  ...
                  <textarea required  class="form-control box" placeholder="Enter your bio" name="bio"></textarea>
                     ...
                     Adhaar Number <input  required type="number" name="adhar" class="form-control box" placeholder="Enter your Adhaar number"/>
